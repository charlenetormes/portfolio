    ...
    <div class="h-full max-w-[68px] py-5 px-6 border-r-[1px] border-lines-100">
        <div class="flex flex-col gap-8">
            <svg
                ...
                @click="handleNavigation(VIEWS.PROFESSIONAL)"
            >
                <g
                    :opacity="view?.professional ? '1' : '0.4'"
                    clip-path="url(#clip0_64_1623)"
            ...
            <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                @click="handleNavigation(VIEWS.PERSONAL)"
            >
                <g
                    :opacity="view?.personal ? '1' : '0.4'"
                    clip-path="url(#clip0_64_1620)"
                    class="hover:opacity-100"
                >
                    <path
            ...
            <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                @click="handleNavigation(VIEWS.HOBBIES)"
            >
                <g
                    :opacity="view?.hobbies ? '1' : '0.4'"
                    clip-path="url(#clip0_64_1617)"
                    class="hover:opacity-100"
                >
                    <path
...
import { VIEWS } from "@/utilities/enums";
const emits = defineEmits(["handleNavigation"]);
...
const handleNavigation = (
    ...
    emits("handleNavigation", newView);
};
</script>
